    ...
    <form action="{{ route('admin.settings.update') }}" method="POST" role="form">
        ...
        <div class="tile-body">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" placeholder="Enter store shipping_charge" id="shipping_charge"
                    name="shipping_charge" value="{{ config('settings.shipping_charge') }}" />
            </div>
        </div>
